...
// --- Grounding Experience Components ---
const Radiate = () => {
          ...
          {step === 'grounding' && (
            ...
            >
              ...
              <div className="absolute bottom-4 right-4 z-20">
                <button onClick={() => goTo('reflection')} className="px-6 py-2 bg-white/20 rounded-lg hover:bg-white/30 transition text-white">
                  Next
                </button>
              </div>
            </motion.div>
